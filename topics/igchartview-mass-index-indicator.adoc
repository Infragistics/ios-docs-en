...
|metadata|
{
    "name": "igchartview-mass-index-indicator",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "271a5165-a146-45e1-bd4d-c0a6459e7517",  
    "buildFlags": [],
    "createdOn": "2013-02-07T20:44:38.0334283Z"
}
|metadata|
////
...
** <<_Ref326220605,Mass Index indicator summary>>
** <<_Ref326220610,Data requirements>>

* <<_Ref327935154,Adding a Mass Index Indicator to the IGChartView  _–_   Code Example>>
...
=== Mass Index indicator summary

The Mass Index indicator is financial indicator used for finding trend reversals, based on the premise that reversals are likely to happen when the price range widens. The calculation, which compares the previous trading ranges (highs minus lows), uses Exponential Moving Averages (EMA). If there is substantial movement, the Mass Index Indicator increases if there is insubstantial movement the Mass Index Indicator decreases.

image::images/IGChartView_-_Mass_Index_Indicator_1.png[]
...
[[_Ref324842387]]
[[_Ref327935154]]
== Adding a Mass Index Indicator to the  _IGChartView_   – Code Example
...
IGMassIndexIndicator financialIndicator = new IGMassIndexIndicator("financialIndicator");
...
----
 NSMutableArray *open = [[NSMutableArray alloc] init];
    ...
    IGMassIndexIndicator *financialIndicator = [[IGMassIndexIndicator alloc] initWithKey:@"financialIndicator"];
    financialIndicator.xAxis = xAxis;
    financialIndicator.yAxis = yAxis;
    financialIndicator.dataSource = source;
    financialIndicator.thickness = 3.0f;
