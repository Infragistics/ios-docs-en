...
|metadata|
{
    "name": "igchartview-slow-stochastic-oscillator-indicator",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "c7e79f09-8b0c-41de-a0a0-e2e3ca924a97",  
    "buildFlags": [],
    "createdOn": "2013-02-08T13:17:34.9666168Z"
}
|metadata|
////
...
** <<_Ref326220605,Slow Stochastic Oscillator Indicator summary>>
** <<_Ref326220610,Data requirements>>

* <<_Ref327935154,Adding a Slow Stochastic Oscillator Indicator to the IGChartView  _–_   Code Example>>
...
=== Slow Stochastic Oscillator Indicator summary

The Slow Stochastic Oscillator indicator is a momentum financial indicator that displays the closing price, relative to the high-low range over a given period using a scale of 0 to 100. The basis for this indicator is the premise that prices will close near 100 in a rising market and close near 0 in a declining market.

Use the Fast Stochastic Oscillator indicator to identify buying or selling divergences. The Slow Stochastic Oscillator uses a 3-day SMA while the Full Stochastic Oscillator is the Slow Stochastic Oscillator with a customized period.

image::images/IGChartView_-_Slow_Stochastic_Oscillator_Indicator_1.png[]
...
*Required –*  the data model must contain numeric fields, representing the high, low, and closing price in order to render data.

[[_Ref324842387]]
[[_Ref327935154]]
== Adding a Slow Stochastic Oscillator Indicator to the  _IGChartView_   – Code Example
...
IGSlowStochasticOscillatorIndicator financialIndicator = new IGSlowStochasticOscillatorIndicator("financialIndicator");
...
----
 NSMutableArray *open = [[NSMutableArray alloc] init];
    ...
    IGSlowStochasticOscillatorIndicator *financialIndicator = [[IGSlowStochasticOscillatorIndicator alloc] initWithKey:@"financialIndicator"];
    financialIndicator.xAxis = xAxis;
    financialIndicator.yAxis = yAxis;
    financialIndicator.dataSource = source;
    financialIndicator.thickness = 3.0f;
