...
|metadata|
{
    "name": "igchartview-percentage-price-oscillator-indicator",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "ce7a4678-12a5-4648-965a-993e7d8933d9",  
    "buildFlags": [],
    "createdOn": "2013-02-08T12:26:56.164767Z"
}
|metadata|
////
...
** <<_Ref326220605,Percentage Price Oscillator Indicator summary>>
** <<_Ref326220610,Data requirements>>

* <<_Ref327935154,Adding a Percentage Price Oscillator Indicator to the IGChartView  _–_   Code Example>>
...
=== Percentage Price Oscillator Indicator summary

The Percentage Price Oscillator indicator is an oscillating indicator that shows the difference between two moving averages as a percentage of the larger of the two moving averages. The Percentage Price Oscillator indicator is very flexible allowing you to selects the period for analysis.

image::images/IGChartView_-_Percentage_Price_Oscillator_Indicator_1.png[]
...
[[_Ref324842387]]
[[_Ref327935154]]
== Adding a Percentage Price Oscillator Indicator to the  _IGChartView_   – Code Example
...
IGPercentagePriceOscillatorIndicator financialIndicator = new IGPercentagePriceOscillatorIndicator("financialIndicator");
...
----
 NSMutableArray *open = [[NSMutableArray alloc] init];
    ...
    IGPercentagePriceOscillatorIndicator *financialIndicator = [[IGPercentagePriceOscillatorIndicator alloc] initWithKey:@"financialIndicator"];
    financialIndicator.xAxis = xAxis;
    financialIndicator.yAxis = yAxis;
    financialIndicator.dataSource = source;
    financialIndicator.thickness = 3.0f;
