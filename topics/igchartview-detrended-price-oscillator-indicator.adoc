...
|metadata|
{
    "name": "igchartview-detrended-price-oscillator-indicator",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "f88551dd-4b08-458d-99b2-4fbb08b82451",  
    "buildFlags": [],
    "createdOn": "2013-02-07T20:18:51.1134283Z"
}
|metadata|
////
...
** <<_Ref326220605,Detrended Price Oscillator Indicator summary>>
** <<_Ref326220610,Data requirements>>

* <<_Ref327935154,Adding a Detrended Price Oscillator Indicator to the IGChartView  _–_   Code Example>>
...
=== Detrended Price Oscillator Indicator summary

The Detrended Price Oscillator Indicator is a financial indicator, based on a displaced moving average and used in order to identify short-term trends. Designed to control for long-term pricing trends, the Detrended Price oscillator, is not a momentum oscillator.

image::images/IGChartView_-_Detrended_Price_Oscillator_Indicator_1.png[]
...
[[_Ref324842387]]
[[_Ref327935154]]
== Adding a Detrended Price Oscillator Indicator to the  _IGChartView_   – Code Example
...
IGDetrendedPriceOscillatorIndicator financialIndicator = new IGDetrendedPriceOscillatorIndicator("financialIndicator");
...
----
 NSMutableArray *open = [[NSMutableArray alloc] init];
    ...
    IGDetrendedPriceOscillatorIndicator *financialIndicator = [[IGDetrendedPriceOscillatorIndicator alloc] initWithKey:@"financialIndicator"];
    financialIndicator.xAxis = xAxis;
    financialIndicator.yAxis = yAxis;
    financialIndicator.dataSource = source;
    financialIndicator.thickness = 3.0f;
