...
|metadata|
{
    "name": "igchartview-relative-strength-index-indicator",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "5b39291e-c8d7-447c-ae65-b48b00c3d31c",  
    "buildFlags": [],
    "createdOn": "2013-02-08T13:12:49.2340464Z"
}
|metadata|
////
...
** <<_Ref326220605,Relative Strength Index Indicator summary>>
** <<_Ref326220610,Data requirements>>

* <<_Ref327935154,Adding a Relative Strength Index Indicator to the IGChartView  _–_   Code Example>>
...
The Relative Strength Index indicator (RSI) is a commonly used measure of market strength or weakness with a range of 0 to 100, and calculated on closing prices during a specified period with its basis formed on the premise that prices close higher in a strong market period and lower in a weak market period. The RSI is the ratio of higher closes to lower closes.

image::images/IGChartView_-_Relative_Strength_Index_Indicator_1.png[]
...
[[_Ref324842387]]
[[_Ref327935154]]
== Adding a Relative Strength Index Indicator to the  _IGChartView_   – Code Example
...
IGRelativeStrengthIndexIndicator financialIndicator = new IGRelativeStrengthIndexIndicator("financialIndicator");
...
----
 NSMutableArray *open = [[NSMutableArray alloc] init];
    ...
    IGRelativeStrengthIndexIndicator *financialIndicator = [[IGRelativeStrengthIndexIndicator alloc] initWithKey:@"financialIndicator"];
    financialIndicator.xAxis = xAxis;
    financialIndicator.yAxis = yAxis;
    financialIndicator.dataSource = source;
    financialIndicator.thickness = 3.0f;
