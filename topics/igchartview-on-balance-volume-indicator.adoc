...
|metadata|
{
    "name": "igchartview-on-balance-volume-indicator",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "f9f318ea-ba13-4f77-9774-5c52ae5ebb25",  
    "buildFlags": [],
    "createdOn": "2013-02-08T12:22:24.3455878Z"
}
|metadata|
////
...
** <<_Ref326220605,On Balance Volume indicator summary>>
** <<_Ref326220610,Data requirements>>

* <<_Ref327935154,Adding an On Balance Volume Indicator to the IGChartView  _–_   Code Example>>
...
The On Balance Volume indicator (OBV) calculates a running total of sales volume for a stock and displays whether this volume is flowing in or out, purchasing and selling respectively. The total volume for a day is given a positive or negative value depending on whether the prices were higher or lower that day than the previous day. A higher closing price yields a positive value while a lower closing price results in a negative value. These values accumulate over time into the running total.

image::images/IGChartView_-_On_Balance_Volume_Indicator_1.png[]
...
[[_Ref324842387]]
[[_Ref327935154]]
== Adding an On Balance Volume Indicator to the  _IGChartView_   – Code Example
...
IGOnBalanceVolumeIndicator financialIndicator = new IGOnBalanceVolumeIndicator("financialIndicator");
...
----
 NSMutableArray *open = [[NSMutableArray alloc] init];
    ...
    IGOnBalanceVolumeIndicator *financialIndicator = [[IGOnBalanceVolumeIndicator alloc] initWithKey:@"financialIndicator"];
    financialIndicator.xAxis = xAxis;
    financialIndicator.yAxis = yAxis;
    financialIndicator.dataSource = source;
    financialIndicator.thickness = 3.0f;
