...
|metadata|
{
    "name": "igchartview-negative-volume-index-indicator",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "dc4e0996-8de6-4303-b6e1-da92bf7d0a4a",  
    "buildFlags": [],
    "createdOn": "2013-02-08T12:15:53.8495421Z"
}
|metadata|
////
...
This topic provides a conceptual overview of the  _IGChartView™_   control’s Negative Volume Index indicator and provides a code example demonstrating how to add it to the chart view.
...
** <<_Ref326220605,Negative Volume Index indicator summary>>
** <<_Ref326220610,Data requirements>>

* <<_Ref327935154,Adding a Negative Volume Index Indicator to the IGChartView  _–_   Code Example>>
...
=== Negative Volume Index indicator summary

Used frequently in combination with the link:igchartview-positive-volume-index-indicator.html[Positive Volume Index Indicator], the Negative Volume Index indicator is useful in identifying bull markets. The premise for both of these indicators is that smart money trades on low volume days and less informed or overly optimistic investors trade on high volume days.

image::images/IGChartView_-_Negative_Volume_Index_Indicator_1.png[]
...
[[_Ref324842387]]
[[_Ref327935154]]
== Adding a Negative Volume Index Indicator to the  _IGChartView_   – Code Example
...
IGNegativeVolumeIndexIndicator financialIndicator = new IGNegativeVolumeIndexIndicator("financialIndicator");
...
----
 NSMutableArray *open = [[NSMutableArray alloc] init];
    ...
    IGNegativeVolumeIndexIndicator *financialIndicator = [[IGNegativeVolumeIndexIndicator alloc] initWithKey:@"financialIndicator"];
    financialIndicator.xAxis = xAxis;
    financialIndicator.yAxis = yAxis;
    financialIndicator.dataSource = source;
    financialIndicator.thickness = 3.0f;
