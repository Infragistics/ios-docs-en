...
|metadata|
{
    "name": "igchartview-chaikin-oscillator-indicator",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "644228df-14b5-4fe0-86f0-eb98e860da7e",  
    "buildFlags": [],
    "createdOn": "2013-02-07T19:51:29.2584283Z"
}
|metadata|
////
...
** <<_Ref326220605,Chaikin Oscillator indicator summary>>
** <<_Ref326220610,Data requirements>>

* <<_Ref327935154,Adding a Chaikin Oscillator Indicator to the IGChartView  _–_   Code Example>>
...
=== Chaikin Oscillator indicator summary

Used to identify trends in the accumulation/distribution indicator, the Chaikin Oscillator is the 10-day exponential moving average (EMA) of the accumulation/distribution indicator subtracted from the 3-day EMA of the accumulation/distribution indicator.

image::images/IGChartView_-_Chaikin_Oscillator_Indicator_1.png[]
...
*Required –*  the data model must contain numeric fields for each high, low, volume and closing values in order to render data.

[[_Ref324842387]]
[[_Ref327935154]]
== Adding a Chaikin Oscillator Indicator to the  _IGChartView_   – Code Example
...
IGChaikinOscillatorIndicator financialIndicator = new IGChaikinOscillatorIndicator("financialIndicator");
...
----
 NSMutableArray *open = [[NSMutableArray alloc] init];
    ...
    IGChaikinOscillatorIndicator *financialIndicator = [[IGChaikinOsciallatorIndicator alloc] initWithKey:@"financialIndicator"];
    financialIndicator.xAxis = xAxis;
    financialIndicator.yAxis = yAxis;
    financialIndicator.dataSource = source;
    financialIndicator.thickness = 3.0f;
