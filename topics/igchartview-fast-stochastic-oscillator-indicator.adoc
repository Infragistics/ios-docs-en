...
|metadata|
{
    "name": "igchartview-fast-stochastic-oscillator-indicator",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "850f1546-e6dc-4f97-80ea-99874f46fe8f",  
    "buildFlags": [],
    "createdOn": "2013-02-07T20:26:42.6784283Z"
}
|metadata|
////
...
** <<_Ref326220605,Fast Stochastic Oscillator Indicator summary>>
** <<_Ref326220610,Data requirements>>

* <<_Ref327935154,Adding a Fast Stochastic Oscillator Indicator to the IGChartView  _–_   Code Example>>
...
=== Fast Stochastic Oscillator Indicator summary

The Fast Stochastic Oscillator indicator is a momentum financial indicator that displays the closing price relative to the high-low range over a given period.
...
The Fast Stochastic Oscillator indicator identifies divergence in either buying or selling divergences. The Slow Stochastic Oscillator uses a 3-day Simple Moving Average (SMA) and the Full Stochastic Oscillator is the Slow Stochastic Oscillator with a specific time interval customization.

image::images/IGChartView_-_Fast_Stochastic_Oscillator_Indicator_1.png[]
...
[[_Ref324842387]]
[[_Ref327935154]]
== Adding a Fast Stochastic Oscillator Indicator to the  _IGChartView_   – Code Example
...
IGFastStochasticOscillatorIndicator financialIndicator = new IGFastStochasticOscillatorIndicator("financialIndicator");
...
----
 NSMutableArray *open = [[NSMutableArray alloc] init];
    ...
    IGFastStochasticOscillatorIndicator *financialIndicator = [[IGFastStochasticOscillatorIndicator alloc] initWithKey:@"financialIndicator"];
    financialIndicator.xAxis = xAxis;
    financialIndicator.yAxis = yAxis;
    financialIndicator.dataSource = source;
    financialIndicator.thickness = 3.0f;
