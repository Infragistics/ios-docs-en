...
|metadata|
{
    "name": "igchartview-williams-percent-range-indicator",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "b3cff76d-edd9-4386-a925-775b1bbff878",  
    "buildFlags": [],
    "createdOn": "2013-02-08T16:09:19.5449716Z"
}
|metadata|
////
...
** <<_Ref326220605,Williams Percent Range indicator summary>>
** <<_Ref326220610,Data requirements>>

* <<_Ref327935154,Adding a Williams Percent Range Indicator to the IGChartView  _–_   Code Example>>
...
=== Williams Percent Range indicator summary

The Williams Percent Range indicator is a momentum indicator similar to the Stochastic Oscillator; however, with a scale ranging from 0 to -100. The Williams Percent Range indicator is useful for identifying overbought and oversold securities. To calculate its value, divide the difference between the highest high for the period and the current close by the highest high minus the lowest low for the period.

image::images/IGChartView_-_Williams_Percent_Range_Indicator_1.png[]
...
*Required –*  the data model must contain numeric fields for the high, low and closing values in order to render data.

[[_Ref324842387]]
[[_Ref327935154]]
== Adding a Williams Percent Range Indicator to the  _IGChartView_   – Code Example
...
IGWilliamsPercentRIndicator financialIndicator = new IGWilliamsPercentRIndicator("financialIndicator");
...
----
 NSMutableArray *open = [[NSMutableArray alloc] init];
    ...
    IGWilliamsPercentRIndicator *financialIndicator = [[IGWilliamsPercentRIndicator alloc] initWithKey:@"financialIndicator"];
    financialIndicator.xAxis = xAxis;
    financialIndicator.yAxis = yAxis;
    financialIndicator.dataSource = source;
    financialIndicator.thickness = 3.0f;
