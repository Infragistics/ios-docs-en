...
|metadata|
{
    "name": "igchartview-stacked-bar-series",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "07fdd297-2336-4f2b-b941-343f5ae8ea76",  
    "buildFlags": [],
    "createdOn": "2013-02-06T14:57:54.0745385Z"
}
|metadata|
////
...
** <<_Ref328076501,Stacked Bar series summary>>
** <<_Ref326327824,Data requirements>>
** <<_Ref219345947,Data rendering rules>>

* <<_Ref328076508,Adding a Stacked Bar Series to the  _IGChartView_   – Code Example>>
...
* Every numeric column in the data model that you want rendered needs an  _IGStackedFragmentSeries_   added to the `series` collection property of the  _IGStackedBarSeries_  .
...
* When rendering multiple series of the Stacked Bar series type in layers, with each successive series rendered in front of the previous one in the `series` collection of the  _IGChartView_   control.

[[_Ref324842387]]
[[_Ref328076508]]
== Adding a Stacked Bar Series to the  _IGChartView_   – Code Example

[[_Ref326327832]]

=== Description

The code below uses the link:igchartview-data-source-helpers.html[IGStackedSeriesDataSourceHelper] to supply randomly generated data to a Stacked Bar series firstly adding to the  _IGChartView_   instance, and then adding the  _IGChartView_   as a subview of the current  _UIView_  .
