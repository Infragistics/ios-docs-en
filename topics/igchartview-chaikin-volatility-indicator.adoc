...
|metadata|
{
    "name": "igchartview-chaikin-volatility-indicator",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "2fdf2462-fb8d-4350-8c29-9ad289857238",  
    "buildFlags": [],
    "createdOn": "2013-02-07T19:58:20.2344283Z"
}
|metadata|
////
...
** <<_Ref326220605,Chaikin Volatility indicator summary>>
** <<_Ref326220610,Data requirements>>

* <<_Ref327935154,Adding a Chaikin Volatility Indicator to the IGChartView  _–_   Code Example>>
...
=== Chaikin Volatility indicator summary

The Chaikin Volatility indicator is a financial indicator that reflects the volatility of a security by showing the percent change of the Exponential Moving Average of the difference between the high and low prices during a specified period.

image::images/IGChartView_-_Chaikin_Volatility_Indicator_1.png[]
...
*Required –*  the data model must contain numeric fields for the high and low values in order to render data.

[[_Ref324842387]]
[[_Ref327935154]]
== Adding a Chaikin Volatility Indicator to the  _IGChartView_   – Code Example
...
IGChaikinVolatilityIndicator financialIndicator = new IGChaikinVolatilityIndicator("financialIndicator");
...
----
 NSMutableArray *open = [[NSMutableArray alloc] init];
    ...
    IGChaikinVolatilityIndicator *financialIndicator = [[IGChaikinVolatilityIndicator alloc] initWithKey:@"financialIndicator"];
    financialIndicator.xAxis = xAxis;
    financialIndicator.yAxis = yAxis;
    financialIndicator.dataSource = source;
    financialIndicator.thickness = 3.0f;
