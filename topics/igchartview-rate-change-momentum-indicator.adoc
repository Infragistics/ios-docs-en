...
|metadata|
{
    "name": "igchartview-rate-change-momentum-indicator",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "27e1c46a-166c-4bfb-b2d1-871564e9fe4d",  
    "buildFlags": [],
    "createdOn": "2013-02-08T13:08:07.2198478Z"
}
|metadata|
////
...
** <<_Ref326220605,Rate of Change and Momentum Indicator summary>>
** <<_Ref326220610,Data requirements>>

* <<_Ref327935154,Adding a Rate of Change and Momentum Indicator to the IGChartView  _–_   Code Example>>
...
=== Rate of Change and Momentum Indicator summary

The Rate of Change and Momentum indicator (ROC&M) calculates the absolute difference of a stock or other security, for a given period, between one closing price and the closing price N days ago, and usually refers to a price trend. When an upward trend continues the momentum and ROC indicators are positive. When a declining trend continues the momentum and ROC indicators are negative.

image::images/IGChartView_-_Rate_of_Change_and_Momentum_Indicator_1.png[]
...
*Required –*  the data model must contain numeric fields for closing values in order to render data.

[[_Ref324842387]]
[[_Ref327935154]]
== Adding a Rate of Change and Momentum Indicator to the  _IGChartView_   – Code Example
...
IGRateOfChangeAndMomentumIndicator financialIndicator = new IGRateOfChangeAndMomentumIndicator("financialIndicator");
...
----
 NSMutableArray *open = [[NSMutableArray alloc] init];
    ...
    IGRateOfChangeAndMomentumIndicator *financialIndicator = [[IGRateOfChangeAndMomentumIndicator alloc] initWithKey:@"financialIndicator"];
    financialIndicator.xAxis = xAxis;
    financialIndicator.yAxis = yAxis;
    financialIndicator.dataSource = source;
    financialIndicator.thickness = 3.0f;
