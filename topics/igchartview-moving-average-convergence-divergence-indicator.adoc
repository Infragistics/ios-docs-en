...
|metadata|
{
    "name": "igchartview-moving-average-convergence-divergence-indicator",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "5e98b8cb-8497-42cd-963e-4ac03fffed90",  
    "buildFlags": [],
    "createdOn": "2013-02-07T21:02:26.9124283Z"
}
|metadata|
////
...
** <<_Ref326220605,Moving Average Convergence Divergence indicator summary>>
** <<_Ref326220610,Data requirements>>

* <<_Ref327935154,Adding a Moving Average Convergence Divergence Indicator to the IGChartView  _–_   Code Example>>
...
=== Moving Average Convergence Divergence indicator summary

Used to identify changes in the strength, direction, momentum, or length of a stock price trend the Moving Average Convergence Divergence indicator (MACD) is one of the most popular indicators for financial services. The MACD computation consists of taking the difference between two exponential moving averages (EMAs) of closing prices with the difference charted over time with a moving average of the difference.

image::images/IGChartView_-_Moving_Average_Convergence_Divergence_Indicator_1.png[]
...
[[_Ref324842387]]
[[_Ref327935154]]
== Adding a Moving Average Convergence Divergence Indicator to the  _IGChartView_   – Code Example
...
IGMovingAverageConvergenceDivergenceIndicator financialIndicator = new IGMovingAverageConvergenceDivergenceIndicator("financialIndicator");
...
----
 NSMutableArray *open = [[NSMutableArray alloc] init];
    ...
    IGMovingAverageConvergenceDivergenceIndicator *financialIndicator = [[IGMovingAverageConvergenceDivergenceIndicator alloc] initWithKey:@"financialIndicator"];
    financialIndicator.xAxis = xAxis;
    financialIndicator.yAxis = yAxis;
    financialIndicator.dataSource = source;
    financialIndicator.thickness = 3.0f;
