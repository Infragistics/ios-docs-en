...
|metadata|
{
    "name": "igchartview-ease-of-movement-indicator",
    "controlName": ["IGChartView"],
    "tags": ["Charting","How Do I"],
    "guid": "94bd5145-d65d-42e6-a92b-6eb57f7ea287",  
    "buildFlags": [],
    "createdOn": "2013-02-07T20:22:23.5954283Z"
}
|metadata|
////
...
** <<_Ref326220605,Ease Of Movement Indicator summary>>
** <<_Ref326220610,Data requirements>>

* <<_Ref327935154,Adding an Ease Of Movement Indicator to the IGChartView  _–_   Code Example>>
...
The Ease Of Movement Indicator is a financial indicator used to identify the volume needed to change the price of a security. Typically, it uses a moving average to smooth out the data rendering.

image::images/IGChartView_-_Ease_Of_Movement_Indicator_1.png[]
...
[[_Ref324842387]]
[[_Ref327935154]]
== Adding an Ease of Movement Indicator to the  _IGChartView_   – Code Example
...
IGEaseOfMovementIndicator financialIndicator = new IGEaseOfMovementIndicator("financialIndicator");
...
----
 NSMutableArray *open = [[NSMutableArray alloc] init];
    ...
    IGEaseOfMovementIndicator *financialIndicator = [[IGEaseOfMovementIndicator alloc] initWithKey:@"financialIndicator"];
    financialIndicator.xAxis = xAxis;
    financialIndicator.yAxis = yAxis;
    financialIndicator.dataSource = source;
    financialIndicator.thickness = 3.0f;
